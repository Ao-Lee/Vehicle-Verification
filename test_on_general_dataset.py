...
from mymodel import GetModel, preprocess_input
import cfg

dir_image = 'E:\\DM\\Udacity\\Carvana\\Data\\aligned\\test'
dir_txt = 'E:\\DM\\Udacity\\Carvana\\validation.txt'
model, triplet_model = GetModel(path=cfg.path_model)
